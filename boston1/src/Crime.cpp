...
void Normalize(Crime & crime) {
    ...
    // group
    local = crime.getGroup();
    Trim(local);
    Capitalize(local);
    crime.setGroup(local);

    // desc
    local = crime.getDescription();
    Trim(local);
    Capitalize(local);
    crime.setDescription(local);

    // District alphaNumeric
    local = crime.getDistrict();
    Trim(local);
    Capitalize(local);
    crime.setDistrict(local);

    // area report 
    local = crime.getAreaReport();
    Trim(local);
    Capitalize(local);
    crime.setAreaReport(local);

    // street
    local = crime.getStreet();
    Trim(local);
    Capitalize(local);
    crime.setStreet(local);
