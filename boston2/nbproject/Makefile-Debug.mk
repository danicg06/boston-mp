...
${OBJECTDIR}/src/ArrayCrimeSetFunctions.o: src/ArrayCrimeSetFunctions.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ArrayCrimeSetFunctions.o src/ArrayCrimeSetFunctions.cpp
...
${OBJECTDIR}/src/CrimeSet.o: src/CrimeSet.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CrimeSet.o src/CrimeSet.cpp
