...
public:
    ...
    /**
     * @brief Constructor that builds an object with the given latitude 
     * and longitude in a string.
     * @p The string must have the following format:
     *                  latitude , longitude
     * @pre The string must have the format previously specified.
     * @param coords, the string with the latitude and longitude.
     */
...
private:
    ...
    /**
     * @brief Extracts the first number found in the string provided.
     * @param number_str, the string that contains a number.
     * @pre The string contains a valid number (decimal or integer).
     */
