...
public:
    ...
    /**
    * @brief Returns if @p crime is smaller than the implicit object;
    ...
    * @param compare An object of Crime. Input parameter
    * @return if @p compare is smaller than the implicit object based on the
    * criteria previously defined.
    */
    bool IsSmaller(const Crime & compare) const;
    
    /**
    * @brief Returns if @p crime is the same as the implicit object
    * criterion among Crimes use the dateTime and ID fields: crime1==crime2 if 
    * crime1.dateTime == crime2.dateTime && crime1._id == crime2._id
    * @param crime An object of Crime. Input parameter
    * @return if @p crime is the same as the implicit object based on the
    * criteria previously defined.
    */
    bool IsSameCrime(const Crime &crime) const;
